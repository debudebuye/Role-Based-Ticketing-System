  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">All Tickets (Admin)</h1>
          <p className="text-gray-600">
            Manage all system tickets with full administrative access
          </p>
        </div>
          ...
          {isLoading ? (
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-2 ml-4">
                      {!ticket.assignedTo && agents && (
                        <select
                          onChange={(e) => e.target.value && handleQuickAssign(ticket._id, e.target.value)}
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-600 mb-4">
                {searchTerm ? 'Try adjusting your search terms or filters.' : 'No tickets in the system yet.'}
              </p>
            </div>
          )}
        </div>
